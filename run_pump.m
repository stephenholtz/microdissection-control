...
L.energyLevelMiliJoules = 7.5;  % manually entered in GAM software, this sets prompt text
L.nShutteredPulses = 50;       % number of shuttered pulses, a for energy stabilization
L.pulseFrequency = 200;         % laser pulse freq, >60Hz is stable for closed loop mode
L.purgeDurSeconds = 1;        % duration of N2 purge prior to lasing (3+ seconds is OK)
