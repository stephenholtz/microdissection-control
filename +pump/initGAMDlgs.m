...
% Walk through GAM Software data entry
    r1 = questdlg({['In GAM Laser Software select "SET MAXIMUM NUMBER OF PULSES" and enter '  num2str(total_pulses)],['change "SET ENERGY LEVEL" to ' num2str(energy_level) '.']},'P.U.M.P. Dissection','Complete','Abort','Abort');
